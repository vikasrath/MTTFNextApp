            ...
            {isHome ?
                ...
                (
                    ...
                    <div
                        ...
                        <h1
                            className="mx-auto max-w-4xl font-display text-4xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl">
                            {title}
                            <span className="relative whitespace-nowrap text-[#3067af] ">
                                <svg aria-hidden="true" viewBox="0 0 418 42" className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#A9BFA8] " preserveAspectRatio="none">
